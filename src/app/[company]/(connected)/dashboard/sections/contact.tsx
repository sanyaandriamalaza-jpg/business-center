  ...
  return (
    <div className="container mx-auto px-4 max-w-5xl ">
      <div className="w-full mx-auto ">
        <div className="mx-auto bg-gradient-to-r from-indigo-900 to-indigo-700 rounded-2xl p-12 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Prêt à Transformer Votre Espace de Travail ?
          </h2>
          <p className=" text-lg xl:text-xl text-indigo-100 max-w-2xl mx-auto mb-8">

        ...
        <div className="flex-1 space-y-4">
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="contract" disabled={disabledTypes.includes("contract")}>Contrat</SelectItem>
                <SelectItem value="compensatory" disabled={disabledTypes.includes("compensatory")}>

...
export default function Parametrepage() {
  ...
  return (
    <div className="py-6 px-4">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h1 className="text-md font-bold text-gray-900 mb-2">Réservations</h1>
        <div className="w-full mb-2">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 ">
        <h1 className="text-md font-bold text-gray-900 mb-2">Notifications</h1>
        <div className="w-full mb-2 flex justify-between ">
          <div>
            <h3 className="text-sm text-gray-800">Notifications par email</h3>
            <span className="text-xs text-gray-600">
              Recevoir les notifications de nouvelles réservations par email
            </span>
          </div>

...
const Features = [
  {
    ...
    href: "/sprayhive/domiciliation/Courriers-Scanners",
    isSm: false,
  },
  {
    icon: FileCheck2,
    ...
    href: "/sprayhive/domiciliation/contractual-info",
    isSm: true,
  },
  {
    icon: FileCog,
    ...
    href: "/sprayhive/domiciliation/general-parameters",
    isSm: true,
  },
  {
    icon: CreditCard,
    ...
    href: "/sprayhive/domiciliation/Facturation",
    isSm: false,
  },
];

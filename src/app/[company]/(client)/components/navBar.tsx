...
export default function NavBar({ isHomePage }: { isHomePage: boolean }) {
  ...
  useEffect(() => {
    if (user) {
      ...
      switch (user.profileType) {
        case "basicUser":
          menu = [
            { label: "Tableau de bord", destination: "/sprayhive/domiciliation" },
            { label: "Profil", destination: "/sprayhive/profile" },
          ];
          break;
        case "adminUser":
          menu = [
            { label: "Tableau de bord", destination: "/sprayhive/admin" },
            { label: "Paramètres", destination: "/sprayhive/admin/settings" },
          ];
          break;
        default:
          menu = [];
  ...
  const classicMenu = [
    ...
    {
      label: "Domiciliation",
      destination: "/sprayhive/business-address",
    },
    {
      label: "Tarifs",
      destination: "/sprayhive/pricing",
    },
    {
      label: "A propos",
      destination: "/sprayhive/about",
    },
    {
      label: "Contact",
      destination: "/sprayhive/contact",
    },
  ];
